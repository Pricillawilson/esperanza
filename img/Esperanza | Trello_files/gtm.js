...
"resource": {
  ...
  "tags":[{
      ...
      "vtp_conversionLabel":"QacsCJrr8HAQ0KSpyAM",
      "vtp_url":["macro",5],
      "vtp_enableReadGaCookie":false,
      "vtp_enableProductReportingCheckbox":false,
      "tag_id":9
      ...
      "vtp_conversionCookiePrefix":"_gcl",
      "vtp_conversionId":"956977744",
      "vtp_conversionLabel":"TxIJCNqi13AQ0KSpyAM",
      "vtp_url":["macro",5],
      "vtp_enableReadGaCookie":false,
      "vtp_enableProductReportingCheckbox":false,
      "tag_id":11
      ...
      "function":"__sp",
      "once_per_event":true,
      "vtp_customParams":["list",["map","key","pagetype","value","remarketing"]],
      "vtp_conversionId":"856618376",
      "vtp_customParamsFormat":"USER_SPECIFIED",
      "vtp_enableOgtRmktParams":false,
      "vtp_url":["macro",5],
      ...
      "function":"__html",
      "once_per_load":true,
      "vtp_html":"\u003Cimg height=\"1\" width=\"1\" style=\"display:none\" src=\"https:\/\/www.facebook.com\/tr?id=1959661357604925\u0026amp;ev=Remarketing\"\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":15
  ...
  "rules":[
    [["if",2],["unless",0,1],["add",0,6,7,15,16,17,18,19,20,21,22,24,29]],
    [["if",4,15,16],["unless",1],["add",1,10,13,15,21,26]],
    [["if",4,17],["unless",1],["add",2,4,5,15,21,25]],
    [["if",4,18],["unless",1],["add",3,9,12,15,21,27]],
    [["if",22,23],["add",8,11,14,15,21,28]],
    [["if",23],["add",23]],
    [["if",3,4],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,21,22,24,25,26,27,29]],
    [["if",4,5],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,21,22,24,25,26,27,29]],
    [["if",4,6],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,21,22,24,25,26,27,29]],
    [["if",4,7],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,21,22,24,25,26,27,29]],
    [["if",4,8],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,21,22,24,25,26,27,29]],
    [["if",4,9],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,21,22,24,25,26,27,29]],
    [["if",4,10],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,21,22,24,25,26,27,29]],
    [["if",4,11],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,21,22,24,25,26,27,29]],
    [["if",4,12],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,21,22,24,25,26,27,29]],
    [["if",4,13],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,21,22,24,25,26,27,29]],
    [["if",4,14],["block",0,1,2,3,4,5,6,7,9,10,12,13,15,16,17,18,19,20,21,22,24,25,26,27,29]],
    [["if",4,19],["block",3,9,12,15,21,27,29]],
    [["if",4,20],["block",3,9,12,15,21,27,29]],
    [["if",4,21],["block",3,9,12,15,21,27,29]]]
},
"runtime":[
[],[]
]
